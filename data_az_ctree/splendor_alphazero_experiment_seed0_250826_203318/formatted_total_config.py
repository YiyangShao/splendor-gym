...
main_config = dict(
    exp_name='data_az_ctree/splendor_alphazero_experiment_seed0_250826_203318',
    env=dict(
        manager=dict(
    ...
    policy=dict(
        ...
        mcts={'num_simulations': 200, 'max_moves': 140, 'root_dirichlet_alpha': 0.3, 'root_noise_weight': 0.25, 'pb_c_base': 19652, 'pb_c_init': 1.25},
